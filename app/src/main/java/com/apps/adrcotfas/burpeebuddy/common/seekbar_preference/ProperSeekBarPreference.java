package com.apps.adrcotfas.burpeebuddy.common.seekbar_preference;
...
public class ProperSeekBarPreference extends Preference {
    ...
    /**
     * Gets whether the {@link ProperSeekBarPreference} should continuously save the {@link SeekBar} value
     ...
     *
     * @return Whether the {@link ProperSeekBarPreference} should continuously save the {@link SeekBar}
    ...
    /**
     * Sets whether the {@link ProperSeekBarPreference} should continuously save the {@link SeekBar} value
     * while it is being dragged.
     *
     * @param updatesContinuously Whether the {@link ProperSeekBarPreference} should continuously save
    ...
    void updateLabelValue(int value) {
        if (mSeekBarValueTextView != null) {
            mSeekBarValueTextView.setText(StringUtils.secondsToTimerFormatAlt(value * BREAK_DURATION_FACTOR));
        }
    }
